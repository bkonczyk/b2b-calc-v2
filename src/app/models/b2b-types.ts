// SAMOCHOD: Typ wyliczeniowy dla rodzaju użytkowania samochodu
export type CarUsageType = 'none' | 'mixed' | 'private';
...
export interface Expense {
    ...
    net: number;
    vat: number;
    carType: CarUsageType; // SAMOCHOD: Nowe pole w modelu danych
}
...
export const TAX_FORM_OPTIONS: TaxFormOption[] = [
    ...
    {key: 'RYCZALT_14', label: 'Ryczałt (14%)', rate: 0.14},
